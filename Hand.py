...
class Hand:
    def __init__(self, hand_info):
        ...
        """Pre-flop"""
        # vars init
        self.preflop_tags = {"pot_type": "No_raise_pot", "Hero_action_tags": []}
        ...
        if street == "pre-flop":
            ...
            if player_info[1][0] == "raises":
                if player_info[0] == "Hero":
                    if "hero_raises" not in self.preflop_tags["Hero_action_tags"]:
                        self.preflop_tags["Hero_action_tags"].append("hero_raises")
                    if self.preflop_tags["pot_type"] == "Limp_pot":
                        self.preflop_tags["Hero_action_tags"].append("hero_isolates")
                ...
                if self.preflop_tags["pot_type"] == "SRP":
                    self.preflop_tags["Hero_action_tags"].append(f"{self.positions[player_info[0]]}_RFI")
                else:
                    self.preflop_tags["Hero_action_tags"].append(f"{self.positions[player_info[0]]}_{self.preflop_tags["pot_type"]}")
            elif player_info[1][0] == "calls":
                if self.preflop_tags["pot_type"] == "No_raise_pot":
                    self.preflop_tags["pot_type"] = "Limp_pot"
                    self.preflop_tags["Hero_action_tags"].append("limped")

                if player_info[0] == "Hero":
                    if "hero_calls" not in self.preflop_tags["Hero_action_tags"]:
                    ...
                    if self.preflop_tags["pot_type"] == "No_raise_pot" or self.preflop_tags["pot_type"] == "Limp_pot":
                        self.preflop_tags["Hero_action_tags"].append("hero_limps")
                    elif self.preflop_tags["pot_type"] == "SRP":
                        self.preflop_tags["Hero_action_tags"].append("hero_calls_to_RFI")
                    elif self.preflop_tags["pot_type"] == "3bet":
                        self.preflop_tags["Hero_action_tags"].append("hero_calls_to_3bet")
                    elif self.preflop_tags["pot_type"] == "4bet":
                        self.preflop_tags["Hero_action_tags"].append("hero_calls_to_4bet")
                    elif self.preflop_tags["pot_type"] == "5bet":
                        self.preflop_tags["Hero_action_tags"].append("hero_calls_to_5bet")
            elif player_info[1][0] == "folds":
                if player_info[0] == "Hero":
                    if "hero_folds" not in self.preflop_tags["Hero_action_tags"]:
                        self.preflop_tags["Hero_action_tags"].append("hero_folds")

                    if self.preflop_tags["pot_type"] == "Limp_pot":
                        self.preflop_tags["Hero_action_tags"].append("hero_folds_to_Limp")
                    elif self.preflop_tags["pot_type"] == "No_raise_pot":
                        self.preflop_tags["Hero_action_tags"].append("hero_folds_to_No_raise")
                    elif self.preflop_tags["pot_type"] == "SRP":
                        self.preflop_tags["Hero_action_tags"].append("hero_folds_to_RFI")
                    elif self.preflop_tags["pot_type"] == "3bet":
                        self.preflop_tags["Hero_action_tags"].append("hero_folds_to_3bet")
                    elif self.preflop_tags["pot_type"] == "4bet":
                        self.preflop_tags["Hero_action_tags"].append("hero_folds_to_4bet")
                    elif self.preflop_tags["pot_type"] == "5bet":
                        self.preflop_tags["Hero_action_tags"].append("hero_folds_to_5bet")
